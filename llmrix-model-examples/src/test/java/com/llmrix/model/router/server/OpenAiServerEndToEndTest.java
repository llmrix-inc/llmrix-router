...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, properties = {
        "llmrix.model.router.server.enabled=true",
        "llmrix.model.router.server.auth.mode=none",
...
@Import(OpenAiServerEndToEndTest.Models.class)
class OpenAiServerEndToEndTest {
