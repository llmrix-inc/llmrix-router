...
public final class Message {
    ...
    public List<ContentPart> contents() { return contents; }
    public boolean textOnly() { return contents.stream().allMatch(TextPart.class::isInstance); }
    ...
    public static Message user(ContentPart... contents) { return new Message("user", List.of(contents)); }
    public static Message assistant(String content) { return new Message("assistant", content); }
    public static Message assistant(ToolCallPart... toolCalls) { return new Message("assistant", List.of(toolCalls)); }
    ...
    @Override public int hashCode() { return Objects.hash(role, contents); }
    @Override public String toString() { return "Message[role=" + role + ", contents=" + contents + "]"; }
}
