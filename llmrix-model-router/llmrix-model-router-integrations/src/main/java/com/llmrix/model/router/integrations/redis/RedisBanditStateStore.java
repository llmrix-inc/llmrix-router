...
public final class RedisBanditStateStore implements BanditStateStore, AutoCloseable {
    ...
    @Override
    public long totalSelections(String namespace) {
        return parseLong(redis.hget(stateKey(namespace), "total_selections"));
    }

    @Override
    public BanditArmStats arm(String namespace, String candidateId) {
    ...
    @Override
    public void recordSelection(String namespace, String candidateId) {
    ...
    @Override
    public void recordReward(String namespace, String candidateId, double reward) {
    ...
    @Override
    public Map<String, BanditArmStats> snapshot(String namespace) {
    ...
    @Override
    public void restore(String namespace, Map<String, BanditArmStats> snapshot) {
    ...
    private String root(String namespace) {
        return keyPrefix + ":{" + encode(requireText(namespace, "namespace")) + "}:bandit";
    }

    private String candidatesKey(String namespace) {
        return root(namespace) + ":candidates";
    }

    private String stateKey(String namespace) {
        return root(namespace) + ":state";
    }

    private String armKey(String namespace, String id) {
        return armKeyEncoded(namespace, encode(requireText(id, "candidateId")));
    }

    private String armKeyEncoded(String namespace, String encoded) {
        return root(namespace) + ":arm:" + encoded;
    }
